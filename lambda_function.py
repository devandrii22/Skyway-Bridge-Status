...
class GetStatus(AbstractRequestHandler):
    """Handler for Skill Launch and GetStatus Intent."""

    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return (is_request_type("LaunchRequest")(handler_input) or
                is_intent_name("GetStatusIntent")(handler_input))
...
class CatchAllExceptionHandler(AbstractExceptionHandler):
    ...
    def handle(self, handler_input, exception):
        ...
        handler_input.response_builder.speak(prompts.EXCEPTION_MESSAGE).ask(
...
sb.add_request_handler(GetStatus())
